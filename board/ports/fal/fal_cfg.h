...
extern struct fal_flash_dev stm32_onchip_flash;
...
{                                                                                                                   \
    ...
    {FAL_PART_MAGIC_WROD, "active_app", "onchip_flash",                           128 * 1024,       128 * 1024, 0}, \
    {FAL_PART_MAGIC_WROD, "backup_app", "onchip_flash",                           256 * 1024,       128 * 1024, 0}, \
    {FAL_PART_MAGIC_WROD,      "patch", "onchip_flash",                           384 * 1024,       128 * 1024, 0}, \
    {FAL_PART_MAGIC_WROD,    "flashdb",    "nor_flash",                                    0,       512 * 1024, 0}, \
